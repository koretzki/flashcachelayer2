...
static void 
DM_MECH_G1_SINGLE_CYLINDER_SEEK_TIME_loader(struct dm_mech_g1 * result, double d)
{
	if (!(d >= 0.0)) {
		//foo
	}
...
static void 
DM_MECH_G1_ADD_WRITE_SETTLING_DELAY_loader(struct dm_mech_g1 * result, double d)
{
...
static void 
DM_MECH_G1_FIRST_TEN_SEEK_TIMES_loader(struct dm_mech_g1 * result, struct lp_list * l)
{
...
static void 
DM_MECH_G1_HPL_SEEK_EQUATION_VALUES_loader(struct dm_mech_g1 * result, struct lp_list * l)
{
